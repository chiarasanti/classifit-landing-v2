    ...
    <section className="bg-indigo-600 text-white text-center rounded-t-[40px] relative lg:pb-56">
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="md:w-[80%] mx-auto">
          ...
          <div className="py-8" />
          <h1>
            Classifit può rivoluzionare il tuo studio: genera per te un sito web
            tramite cui i tuoi clienti possono iscriversi alle lezioni, e ti
            fornisce una piattaforma di amministrazione per gestire lezioni,
            pacchetti e tutti i tuoi iscritti.
          </h1>
        </div>
        <Image
          src="/user.svg"
